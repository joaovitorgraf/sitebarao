    ...
    ?>
        ...
        <table class="table table-striped projects">
            ...
            <tbody>
                ...
                if ($pesquisa == "") {
                    $sql = "SELECT * FROM noticia ORDER by data_hora";
            ...
            <tbody>
                ...
                <tr>
                    <td><?php echo $row_usuario["sub_titulo"] ?></td>
                    <td><?php $date = $row_usuario["data_hora"];
                        echo date('d/m/Y', strtotime($date)); ?>
                    </td>
                    <td class="text-right py-0 align-middle">
                        <div class="btn-group btn-group-sm">
                            <?php echo '<a class="btn btn-info" href="#" data-toggle="modal" data-target="#editaAviso' . $row_usuario['id_noticia'] . '"><i class="fas fa-eye"></i></a>'; ?>
                            <?php echo '<a class="btn btn-danger" href="#" data-toggle="modal" data-target="#excluiAviso' . $row_usuario['id_noticia'] . '"><i class="fas fa-trash"></i></a>'; ?>
                        </div>
                    </td>
                </tr>
            ...
            <!--Modal editar aviso-->
            <div class="modal fade bd-example-modal-lg" id="editaAviso<?php echo $row_usuario['id_noticia']; ?>" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="POST" name="EditaAviso" action="../../../atualiza_aviso2.php" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col lg-6">
                                ...
                                <div class="row">
                                    <div class="col lg-6">
                                        <div class="input-group mb-3">
                                            <input class="form-control" type="text" name="sub_titulo" value="<?php echo $row_usuario['sub_titulo'] ?>">
                                ...
                                <div class="row">
                                    <div class="col lg-6">
                                        <div class="input-group mb-3">
                                            <input type="hidden" name="id_noticia" value="<?php echo $row_usuario['id_noticia'] ?>">
                                            <input type="text" class="form-control" name="titulo" value="<?php echo $row_usuario['titulo'] ?>">
                                            <div class="input-group-append">
                                                <div class="input-group-text">
                                                    <span>
                                ...
                                <div class="form-group">
                                    ...
                                    <?php
                                    echo "<textarea id='summernote' name='noticia'>" . $row_usuario['noticia'] . "</textarea>";
                                    ?>
                                </div>
            ...
            <!--Modal excluir aviso-->
            <div class="modal fade" id="excluiAviso<?php echo $row_usuario['id_noticia']; ?>">
                    ...
                    <div class="modal-content" style="border-radius: 16px;">
                        <div class=" card-outline card-success" style="border-radius: 16px;">
                            ...
                            <div class="modal-footer justify-content-between">
                                ...
                                <?php echo '<a href="../../../exclui_aviso2.php?id=' . $row_usuario['id_noticia'] . '" class="btn btn-sm btn-success swalDefaultDelete">Sim</a>'; ?>
                            </div>
                        </div>
                    </div><!-- /.modal-content -->
                </div><!-- /.modal-dialog -->
